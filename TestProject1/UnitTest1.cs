...
namespace TestProject1
{
    ...
    {
        private static TestKonsole Konsole = new();
        ...
        public void TestFizzParse()
        {
            ...
            {
                Assert.AreEqual(entry.Word, FizzBuzzParser.GetFizzBuzzValue(entry.Value));
            }
        }
        [TestMethod]
        ...
        public void TestHadleUserInput_Invalid()
        {
            ...
            Assert.AreEqual(">> Number cannot be negative or 0. Min 1; << -1", Konsole.PrintedLines[Konsole.PrintedLines.Count -1]);
            
            // Too high
            Konsole.TestCase = TestCases.SingleValueTest("301");
            Engine.HandleUserInput();
            
            Assert.AreEqual(">> Number was too high. Max 300; << 301", Konsole.PrintedLines[Konsole.PrintedLines.Count -1]);
